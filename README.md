...
<!-- PROJECT LOGO -->
<br />
1. DIMAS ARDIMINDA EDIA PUTRA (220535608555)
2. MELANI PUTRI DEWINTA (220533608063) 
3. NADIA SALMA NAFISAH (220533604762) 
4. NUR AFNI (220533611570)
5. ERYZA SATRIA PRIMADITA (220535608800)
...
7. Run database migration
    ...
    php artisan migrate
    ```
8. Setup done, you can run localy using this command
    ```sh
    php artisan serve
    ```
